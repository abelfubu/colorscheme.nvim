...
theme.set_highlights = function()
	...
	hl(0, "@keyword.if.vim", { fg = c.blue, bg = "NONE", italic = true })
	...
	hl(0, "@conditional.lua", { fg = c.blue, bg = "NONE", italic = true })
	...
	hl(0, "@object.key", { fg = c.green, bg = "NONE", italic = true })
	...
	hl(0, "TelescopePromptPrefix", { fg = c.orange, bg = c.bg })
