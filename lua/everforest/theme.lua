...
theme.set_highlights = function(opts)
	...
	hl(0, "Comment", { fg = c.dark_cyan, bg = "NONE", italic = opts.italics })
	...
	hl(0, "@namespace.vim", { fg = c.light_blue, bg = "NONE", italic = opts.italic })
	...
	hl(0, "@object.property", { fg = c.light_yellow, bg = "NONE", italic = opts.italic })
	...
	hl(0, "@angular", { fg = c.light, bg = "NONE", italic = opts.italic })
	...
	hl(0, "TelescopePromptBorder", { fg = c.gray, bg = "NONE" })
	...
	hl(0, "NvimTreeWindowPicker", { fg = c.green, bg = c.dark, bold = true, italic = opts.italic })
